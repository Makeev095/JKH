...
//                self.configureGoogleAuth(user: user, error: error)
//            }
//        } else {
//            let signInConfig = GIDConfiguration(clientID: "1038402041047-4d42bec43g841shbe8tdsseq2dql7kf8")
...
//    }
//    
//    func configureGoogleAuth(user: GIDGoogleUser?, error: Error?) {
//        if let error = error {
...
//        
//        service.authorizer = GTMFetcherAuthorizationToken(authorizerWithToken: accessToken)
//        
...
//
//    private func uploadReadingsToGoogleSheets(water: String, gas: String) {
//        let spreadsheetId = "173LJSu22SZltMdg-X-2p30iOeAh5qFzTCx-SzrUjJo4"
//        let range = "Sheet1!A1"
//
//        let valueRange = GTLRSheets_ValueRange()
//        valueRange.values = [[selectedAddress ?? "Неизвестный адрес", water, gas, Date().description]]
//
